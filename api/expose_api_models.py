...
def expose_models(api, method_decorators = []): 
    ...
    """
    api.expose_object(database.models.Cart, method_decorators= method_decorators)
    api.expose_object(database.models.Customer, method_decorators= method_decorators)
    api.expose_object(database.models.CartItem, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.ProductPromotion, method_decorators= method_decorators)
    api.expose_object(database.models.Promotion, method_decorators= method_decorators)
    api.expose_object(database.models.Shipping, method_decorators= method_decorators)
    api.expose_object(database.models.Supplier, method_decorators= method_decorators)
    api.expose_object(database.models.SupplierProduct, method_decorators= method_decorators)
    return api
